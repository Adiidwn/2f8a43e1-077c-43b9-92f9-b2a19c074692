...
__decorate([
    (0, swagger_2.ApiOperation)({ summary: 'register' }),
...
__decorate([
    (0, swagger_2.ApiOperation)({ summary: 'auth-check' }),
    ...
    __metadata("design:returntype", Promise)
], AuthController.prototype, "authCheck", null);
__decorate([
    (0, swagger_2.ApiOperation)({ summary: '' }),
    (0, common_1.Get)('/'),
...
__decorate([
    (0, swagger_2.ApiOperation)({ summary: 'update' }),
